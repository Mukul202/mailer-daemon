...
export default function Home({ posts }: Props) {
  ...
  <div className="text-xl  p-2  md:text-1.5xl">Student run newsletter of IIT(ISM) Dhanbad.</div>
      ...
      <div className='hidden md:inline-block absolute w-72 h-72 bg-purple-500 rounded-full top-[50vh] -right-32 mix-blend-multiply opacity-80 blur-sm overflow-hidden'></div>
      {/* posts */}
