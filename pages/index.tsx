...
export default function Home({ posts }: Props) {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <Header />
      <div className="flex items-center justify-between border-y border-black bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 py-10 lg:py-0 mt-4 mb-5">
