  ...
  return (
    <header className="mx-auto flex max-w-7xl justify-between p-5">
      ...
      <div className="flex flex-row ">
        ...
        <button type="button" className="text-gray-900 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Placementor</button>
      </a>
      {/* </Link> */}
